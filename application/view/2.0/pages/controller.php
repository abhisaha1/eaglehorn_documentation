...
<div class="bs-callout bs-callout-info">
    If your URL is <code>http://localhost/projectfolder/public/user/login/para1/para2</code>, then
    it will call the <code>user controller</code> and <code> login method</code> 
    by passing <code>para1 and para2 parameters</code>
    <br><br>
    If your URL is <code>http://localhost/projectfolder/public/user/</code>, then
...
class User extends Base
{
    ...
    function method2()
    {
        $constructor_paras = array(\'para1\',\'para2\');
        $method_paras = array(\'para1\',\'para2\');
