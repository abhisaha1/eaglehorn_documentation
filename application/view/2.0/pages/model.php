...
<hr>
<p>
    A model is responsible to perform CRUD operations.
</p>
<hr>
<div class="bs-callout bs-callout-info">
    <h4>RedBeanPHP</h4>
    <p>RedBeanPHP which is an excellent ORM Class has been integrated with Eaglehorn. Dont forget to checkout
    its <a href="http://www.redbeanphp.com/" target="_blank">documentation here.</a></p>
</div>
<hr>
<h4>Naming the model:</h4>
As models are not displayed in the url, fancy names are allowed. But to keep everything standard, <br>
...
//using RedBeanPHP. Extends model for connection.
...
//For other operations, visit http://readbeanphp.com
?>')

    ?>
</div>

<h4>Using Eaglehorn's PDO</h4>
<div class="bs-callout bs-callout-info">
